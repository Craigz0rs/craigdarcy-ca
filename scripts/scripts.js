...
$(window).scroll(function() {
    if ($(this).scrollTop() > 75) { //if page is scrolled past this many px (75)
        $('nav').addClass("scrolled"); //Add the scrolled class to the header element
    }else {
        $('nav').removeClass("scrolled"); //remove scrolled class when less than 75px
    }
});
...
const projects_toggle = document.getElementById("project-toggle")
const about_me = document.getElementById("about-me")
const projects = document.getElementById("projects")

about_toggle.addEventListener('click', function() {
  if (!about_toggle.classList.contains('nav-active')) {
    classChange(about_toggle, projects_toggle)
  }
})

projects_toggle.addEventListener('click', function() {
    if (!projects_toggle.classList.contains('nav-active')) {
      classChange(projects_toggle, about_toggle)
    }
 })
