<template>
  <section id="about-me" class="fadeIn trigger">
    ...
    <p>Fast forward to recent years; I had been interested in design and development for many years but didn't think that coding was something I would be able to learn. After meeting people in the industry and looking up modern coding resources online I discovered that it was something anyone could learn. I enrolled in some Java Application Development courses at BCIT to see if it was for me and gained some foundational skills in OOP. I then enrolled in BCIT's Technical Web Design program and learned to design and build fully functional websites in only a few months. Since I finished that program I have worked on projects for real clients and made some fun side projects for my own learning.</p>
    <p>Outside of my design and development interests you can find me pursuing my fitness goals, Netflix binging, and eating burgers.</p>
    <p>I am currently seeking front-end developer roles in the Vancouver and Calgary regions.</p>
  </section>
</template>
